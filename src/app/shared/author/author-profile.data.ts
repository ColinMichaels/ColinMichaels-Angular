...
export const COLIN_AUTHOR_PROFILE: AuthorProfile = {
  ...
  shortBio: 'Colin Michaels is an applications developer, FPV drone pilot, and creative technologist based in Florida. He writes about frontend systems, creative tools, media workflows, FPV projects, and recovery after open-heart surgery.',
