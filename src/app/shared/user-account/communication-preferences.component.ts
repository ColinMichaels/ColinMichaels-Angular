  ...
  template: `
    <section class="space-y-5" aria-labelledby="communication-preferences-title">
      <header class="space-y-2">
        <p class="text-sm font-semibold uppercase tracking-[0.18em] text-cyan-300">Notifications</p>
        <h2 id="communication-preferences-title" class="text-xl font-semibold text-zinc-50">
          Get new-post alerts on this device
        </h2>
        <p class="text-sm leading-6 text-zinc-400">
          Browser alerts are managed per device and are the only reader-update delivery currently active.
        </p>
      </header>
