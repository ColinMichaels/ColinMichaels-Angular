      ...
      <section class="mx-auto max-w-7xl space-y-8">
        <nav class="flex flex-wrap items-center justify-between gap-3 text-sm text-zinc-400">
          <div class="flex items-center gap-4">
            ...
            <a routerLink="/admin/cms/media-library" class="hover:text-zinc-100">Media</a>
          </div>
          <a routerLink="/" fragment="home-article-hero" class="hover:text-zinc-100">Homepage Hero</a>
        </nav>
