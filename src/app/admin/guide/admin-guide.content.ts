...
export const ADMIN_GUIDE_ENTRIES: readonly AdminGuideEntry[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {text: 'Existing flat lists, nested lists, checklist state, and ordered-list counters are preserved when a post is saved. Review long links and nested lists in Production Preview at Mobile width and 200 percent Reader text. A compatibility-protected list or chart reopens automatically when its preserved data now passes the current supported-block contract; confirm it in Production Preview, then use Save Post to persist the repaired public block. If Compatibility protection remains, use View preserved JSON for diagnosis and leave the block intact unless you intend to remove or separately migrate its original content.'},
