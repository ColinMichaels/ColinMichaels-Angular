...
export const ADMIN_GUIDE_ENTRIES: readonly AdminGuideEntry[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {text: 'If another editor or backend process changes the post, do not repeatedly retry the stale save. Compare the recovery, reload the latest remote revision when available, or choose Save as new draft to preserve your local version under a new post ID. If New Post reports expected revision 0 and found revision 1, the first save already created the draft: use the automatically opened Recovery & Conflicts panel and choose Reload remote. The editor preserves the local recovery copy, adopts revision 1, and moves to the post edit route; choose Save as new draft only when you intentionally want a duplicate. If the slug is already reserved, choose a different slug; the service will not overwrite the other post.'},
