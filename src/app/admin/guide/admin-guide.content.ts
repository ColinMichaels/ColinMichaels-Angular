...
export const ADMIN_GUIDE_ENTRIES: readonly AdminGuideEntry[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {text: 'Use WYSIWYG for visual editing or choose JSON in Article Content to inspect and edit the raw Editor.js document. Invalid JSON stays in source mode and cannot render or save until corrected.'},
