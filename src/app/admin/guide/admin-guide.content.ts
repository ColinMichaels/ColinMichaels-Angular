...
export const ADMIN_GUIDE_ENTRIES: readonly AdminGuideEntry[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {text: 'Review the post’s advisory checklist and Production Preview, then save the individual post. Return to Posts and confirm it moves from Needs review to Reviewed.'},
    ],
