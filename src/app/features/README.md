...
- `submissions`: shared public contact and prospective-author questionnaires backed by a trusted, rate-limited callable
  boundary. Applications remain private review records and never grant author, post, role, or CMS access automatically.
