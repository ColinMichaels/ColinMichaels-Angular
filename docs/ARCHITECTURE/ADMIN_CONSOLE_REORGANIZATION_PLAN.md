...
- Phase 3 has started with shared page-header and editor-action-bar contracts for Homepage Hero, Topics, and Recommended Links. This removes duplicated identity and save-state markup, adds live unsaved/busy feedback, and leaves routes, Firestore operations, and specialized list/detail editors unchanged.
...
- Social Connections (`/admin/cms/social-connections`)
...
Status: in progress. Homepage Hero, Topics, and Recommended Links now share Phase 3 page-header and editor-action-bar contracts; broader list/detail normalization and the remaining Media, Comments, and Users surfaces are still pending.
