...
Recent source work includes cinematic topic-page heroes, bounded in-body image previews for post listings, a paginated device-local Reading library on Profile, hardened post-package imports, and a repeatable local release gate. Local source, Firebase preview, and production deployment remain separate states.
